...
if(WIN32)
    # Search for SDL2 Debug CMake build in lib/SDL2-2.0.12/build
    find_path(SDL2_ROOT "include/SDL.h" PATHS "${CMAKE_CURRENT_LIST_DIR}/../lib/SDL2-2.0.12" NO_DEFAULT_PATH)
    if(SDL2_ROOT)
    ...
    if(NOT SDL2_FOUND)
        # Search for SDL2 in lib/SDL2-2.0.12
        find_path(SDL2_ROOT "include/SDL.h" PATHS "${CMAKE_CURRENT_LIST_DIR}/../lib/SDL2-2.0.12" NO_DEFAULT_PATH)
        if(SDL2_ROOT)
            set(SDL2_INCLUDE_DIRS "${SDL2_ROOT}/include")
